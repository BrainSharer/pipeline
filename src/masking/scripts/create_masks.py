...
from library.mask_utilities.mask_class import MaskPrediction
...
if __name__ == "__main__":
    ...
    parser.add_argument('--annotator_id', help='ID of user', required=False, default=1, type=int)
    ...
    function_mapping = {
        ...
        "mask": mask_predictor.masks_from_database
    }
