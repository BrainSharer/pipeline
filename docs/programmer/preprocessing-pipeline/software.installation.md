...
1. We are currently using Ubuntu 22.04 as of October 2023 (22.04 is on muralis). Either install this 
on your local machine or install it as a VM with Virtualbox or VMware. 
